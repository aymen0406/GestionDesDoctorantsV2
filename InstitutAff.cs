...
{
    public partial class InstitutAff : UserControl
    {
        int w, h;
        DataTable dt = new DataTable();
        public InstitutAff(int w1, int h1)
        {
            InitializeComponent();
            w = w1;
            h = h1;
        ...
        private void InstitutAff_Load(object sender, EventArgs e)
        {
            panel1.Height = h;
            panel1.Width = w;
            ...
            DGVInstitut.Location = new Point(10, groupBoxRecherche.Location.Y + groupBoxRecherche.Height + 10);
            DGVInstitut.Height = panel1.Height - 90;
            DGVInstitut.Width = panel1.Width - 200;

            DGVInstitut.EnableHeadersVisualStyles = false;
            //DGVEnseignant.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(91,192,222);
            DGVInstitut.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(204, 215, 252);
