...
{
    public partial class InscriptionAffiche : UserControl
    {
        int w, h;
        DataTable dt = new DataTable();
        DataTable dt3 = new DataTable();
        int r = 0;
        string Paths = @"C:\Users\SatelliteT\Documents\visual studio 2013\Projects\GestionEnseignant\GestionEnseignant\Documents\";
        public InscriptionAffiche(int w1, int h1)
        {
            InitializeComponent();
            w = w1;
            h = h1;
        ...
        private void InscriptionAffiche_Load(object sender, EventArgs e)
        { 
            panel1.Height = h;
            panel1.Width=w;
            ...
            DGVInscription.Location = new Point(10, groupBoxRecherche.Location.Y + groupBoxRecherche.Height + 10);
            DGVInscription.Height = panel1.Height-90;
            DGVInscription.Width =panel1.Width-200;

            DGVInscription.EnableHeadersVisualStyles = false;
            //DGVEnseignant.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(91,192,222);
            DGVInscription.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(204, 215, 252);
        ...
        {
            DGVInscription.Rows.Clear();

            DAL.DALInscription E = new DAL.DALInscription();
            dt = E.NewSelect();
            string NomPrenom = "";
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                NomPrenom = "" + dt.Rows[i][1].ToString().Trim() + " " + dt.Rows[i][2].ToString().Trim();
                DGVInscription.Rows.Add(dt.Rows[0][0],NomPrenom, dt.Rows[i][3].ToString().Trim(), 
                    dt.Rows[i][4].ToString().Trim(), dt.Rows[i][5].ToString().Trim());
        ...
        //{
        //    ChoixAjoutEnseignant frm = new ChoixAjoutEnseignant();
        //    frm.ShowDialog();
        //    RaffraichirGrid();
        //}
        ...
        private void DGVEnseignant_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawRectangle(couleur, 0, 0, DGVInscription.Width - 1, DGVInscription.Height - 1);
        }
        ...
        private void btnAjouter_Click(object sender, EventArgs e)
        {
            Inscription frm = new Inscription();
            frm.ShowDialog();
        }

        private void btnImprimer_Click(object sender, EventArgs e)
        {
            FormPDFGenerator frm = new FormPDFGenerator();
            frm.ShowDialog();
        }     
