...
{
    public partial class StructRechAff : UserControl
    {
        int w, h;
        public StructRechAff(int w1, int h1)
        {
            InitializeComponent();
            w = w1;
            h = h1;
        ...
        private void StructRechAff_Load(object sender, EventArgs e)
        {
            panel1.Height = h;
            panel1.Width = w;
            ...
            DGVStructRech3423432.Location = new Point(10, groupBoxRecherche.Location.Y + groupBoxRecherche.Height + 10);
            DGVStructRech3423432.Height = panel1.Height - 90;
            DGVStructRech3423432.Width = panel1.Width - 200;

            DGVStructRech3423432.EnableHeadersVisualStyles = false;
            //DGVEnseignant.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(91,192,222);
            DGVStructRech3423432.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(204, 215, 252);
        ...
        private void DGVStructRech_Paint(object sender, PaintEventArgs e)
        {
            Pen couleur = new Pen(Color.LightGray, 1);
            e.Graphics.DrawRectangle(couleur, 0, 0, DGVStructRech3423432.Width - 1, DGVStructRech3423432.Height - 1);
        }
