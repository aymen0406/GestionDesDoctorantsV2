...
{
    public partial class SoutenanceAffiche : UserControl
    {
        int w, h;
        ...
        public SoutenanceAffiche(int w1, int h1)
        {
            InitializeComponent();
            w = w1;
            h = h1;
        ...
        private void SoutenanceAffiche_Load(object sender, EventArgs e)
        { 
            panel1.Height = h;
            panel1.Width=w;
        ...
        //        {
        //            if (dt.Rows[i][1].ToString().Trim() == "0000000000")
        //                matricule = "";
        //            else
        //                matricule = dt.Rows[i][1].ToString().Trim();
        //            NomPrenom = "" + dt.Rows[i][3].ToString().Trim() + " " + dt.Rows[i][4].ToString().Trim();
        //            DGVEnseignant.Rows.Add(NomPrenom, dt.Rows[i][2].ToString().Trim(), matricule,
        //                dt.Rows[i][7].ToString().Trim(), dt.Rows[i][14].ToString().Trim(), dt.Rows[i][11].ToString().Trim(),
        //                dt.Rows[i][17].ToString().Trim());
        ...
        {
          //  SoutenanceAffiche frm = new SoutenanceAffiche(/*cin1*/);
            //           frm.ShowDialog();
